  ...
  return (
    <form onSubmit={handleSubmit} className="form-container" style={{ maxWidth: '100%', margin: 0, width: '100%' }}>
        ...
        <Grid item xs={12} md={8}>
          <TextField label="Nombre completo" name="nombre" value={admin.nombre} onChange={handleChange} fullWidth required size="small" margin="dense" />
        </Grid>
        <Grid item xs={12} md={4}>
          <TextField label="Correo" name="correo" type="email" value={admin.correo} onChange={handleChange} fullWidth required size="small" margin="dense" />
        </Grid>

        <Grid item xs={12} md={4}>
          <TextField label="CURP" name="curp" value={admin.curp} onChange={handleChange} fullWidth size="small" margin="dense" inputProps={{ maxLength: 18 }} helperText={errors.curp || '18 caracteres (alfanumérico)'} error={Boolean(errors.curp)} />
        </Grid>
        <Grid item xs={12} md={4}>
          <TextField label="Teléfono" name="telefono" value={admin.telefono} onChange={handleChange} fullWidth size="small" margin="dense" inputProps={{ maxLength: 10 }} helperText={errors.telefono || '10 dígitos'} error={Boolean(errors.telefono)} />
        </Grid>
        <Grid item xs={12} md={4}>
          <TextField label="Dirección" name="direccion" value={admin.direccion} onChange={handleChange} fullWidth size="small" margin="dense" />
        </Grid>

        <Grid item xs={12} md={4}>
          <Select name="gradoEstudio" value={admin.gradoEstudio} onChange={handleChange} fullWidth size="small" displayEmpty>
        ...
        <Grid item xs={12} md={4}>
          <Select name="ubicacion" value={admin.ubicacion} onChange={handleChange} fullWidth size="small" displayEmpty>
