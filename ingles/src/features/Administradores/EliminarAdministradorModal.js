...
export default function EliminarAdministradorModal({ open, onClose, admin, eliminarAdministrador }) {
  if (!admin) return null;

  const handleDelete = () => {
    eliminarAdministrador(admin.numero_empleado);
    onClose();
  };
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        <div style={{ padding: 10, textAlign: 'center' }}>
          <p>¿Estás seguro que deseas eliminar al siguiente administrador?</p>
